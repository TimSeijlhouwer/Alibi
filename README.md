# Dossier — eerste testversie

Een sociaal deductiespel waarin de dader méér weet dan de rest. Eén map: **Storm op Huize Reinhart**, met drie minigames (alibi-kruisverhoor, bewijs interpreteren, deductieraster met giftige aanwijzing) en een individuele eindbeschuldiging.
...
- **Lobby**: host maakt een spel (4-lettercode), 4–5 spelers joinen op hun telefoon.
- **Start**: iedereen krijgt een personage; één willekeurige speler wordt in het geheim de dader (Isabel) en ziet de volledige oplossing + briefing. Niet-bezette personages doen mee als NPC-verklaringen.
...
- **Eindbeschuldiging**: ieder vult zelf wie/waar/waarmee/waarom in. Meerderheid goed op de dader = gepakt → burgers winnen, hoogste score = beste rechercheur. Niet gepakt = de dader wint (en scoort op elke misser).
...
data/reinhart.js       → de map: verhaal, alibi's, rondes, oplossing
